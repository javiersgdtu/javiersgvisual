...
d3.json("data/data_out/time_scene.json").then(function(dataInit) {
...
function drawHeatMap(dataInit) {
    ...
    var svg = d3.select("#heatmap-svg").append("g").attr("transform", "translate(1000,50)");
    ...
    colorCharacter.domain(datacircle)
    var offsetfam = 0
        //console.log([...Array(10).keys()])
    var circles = heat.append("g").attr("class", "character-heatmap")
        .selectAll("circle")
        .data(datacircle)
        .enter()
        .append("circle")
