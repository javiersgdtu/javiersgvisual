/*
This is the original House version with a timeline. 
*/
var width = d3.select("svg").attr("width") / 2
var height = d3.select("svg").attr("height") / 2
...
//Text associated with each Room.
var roomtext = svg
    .append("text")
    .attr("x", d3.select("svg").attr("width") / 4)
    .attr("y", 70)
    .text("PARASITE")
