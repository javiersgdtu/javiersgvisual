        ...
        function restart() {
            ...
            node = node.enter().append("circle")
                ...
                .on("mouseover", function(event, d) {
                    ...
                    tooltip
                        .html("<p style='text-align:center;margin:2px'><b>Character:</b> " + d.character + "</p><b>Location:</b> " + d.location + ". </br><b>Duration in Location</b>: " + d.difference + " s</br><b>Action:</b> " + d.action)
